<!DOCTYPE html>
<?php
    setcookie('python', isset($_COOKIE['python']) ? ++$_COOKIE['python'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"Python Course Page",time()+60*60,"/");
?>
<html>
...
<body style="background: #3a3a3a">
	...
	<div class="row" style="font-size: 17px;color: white">
		...
		<div class="col-md-10">
			...
			<div class="row">
				<img src="https://www.tutorialspoint.com/python/images/python.jpg" alt="Mountain View" width="100%" height="100%">
			</div>
		</div>
		<div class="col-md-1">
