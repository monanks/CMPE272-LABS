<!DOCTYPE html>
<?php
    setcookie('mysql', isset($_COOKIE['mysql']) ? ++$_COOKIE['mysql'] : 1,time()+60*60,"/");
    ...
    setcookie($c,"MySQL Course Page",time()+60*60,"/");
?>
<html>
...
<body style="background: #3a3a3a">
	...
	<div class="row" style="font-size: 17px;color: white">
		...
		<div class="col-md-10">
			...
			<div class="row">
				<img src="https://www.tutorialspoint.com/mysql/images/mysql.jpg" alt="Mountain View" width="100%" height="100%">
			</div>
		</div>
		<div class="col-md-1">
