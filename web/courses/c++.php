<!DOCTYPE html>
<?php
    setcookie('cpp', isset($_COOKIE['cpp']) ? ++$_COOKIE['cpp'] : 1,time()+60*60,"/");
...
<body style="background: #3a3a3a">
	...
	<div class="row" style="font-size: 17px;color: white">
		...
		<div class="col-md-10">
			...
			<div class="row">
				<img src="https://www.tutorialspoint.com/cplusplus/images/cplusplus.jpg" alt="Mountain View" width="100%" height="100%">
			</div>
		</div>
		<div class="col-md-1">
